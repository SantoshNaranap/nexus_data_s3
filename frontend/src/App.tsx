    ...
    <div className="flex h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-white transition-colors duration-200">
      ...
      <div className="flex-1 flex flex-col">
        ...
        {selectedDatasource?.id === 'what_you_missed' ? (
          ...
          <ChatInterface datasource={selectedDatasource} isConfigured={configuredDatasources.has(selectedDatasource.id)} connectedAccount={connectedAccounts.get(selectedDatasource.id)} onOpenSettings={() => setSettingsPanelOpen(true)} />
        ) : (
