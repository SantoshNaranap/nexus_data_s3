              ...
              <div
                className={`max-w-3xl px-5 py-4 ${
                  message.role === 'user'
                    ...
                    ? 'bg-red-50 dark:bg-red-900/10 text-red-800 dark:text-red-200 rounded-xl border border-red-200 dark:border-red-800/50'
                    : 'bg-white dark:bg-gray-800/80 text-gray-800 dark:text-gray-200 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700/50'
              ...
              >
                {message.role === 'user' ? (
                  ...
                  <>
                    ...
                    {/* Sources - Clean minimal style */}
                    {message.sources && message.sources.length > 0 && (
                      <div className="mt-4 pt-3 border-t border-gray-100 dark:border-gray-700/50">
                        <p className="text-xs text-gray-500 dark:text-gray-400 mb-2 font-medium">Sources</p>
                        <div className="flex flex-wrap gap-1.5">
                          {message.sources.map((source, idx) => (
                            <span
                              key={idx}
                              className="inline-flex items-center gap-1 px-2 py-0.5 bg-gray-100 dark:bg-gray-700/50 rounded text-xs text-gray-600 dark:text-gray-400"
                            >
                              {source.name}
                            </span>
                          ))}
                    ...
                    {/* Follow-up questions - Clean minimal style */}
                        ...
                        <div className="space-y-1">
                          {message.followUpQuestions.map((question, idx) => (
                            <button
                              ...
                              disabled={isStreaming}
                              className="w-full text-left px-3 py-2 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700/30 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                              {question}
                            </button>
                          ))}
                ...
                {message.timestamp && (
                  <div className="text-xs text-gray-400 dark:text-gray-500 mt-3 flex items-center gap-3">
          ...
          {isStreaming && (
            <div className="flex justify-start">
              <div className="max-w-3xl w-full">
                ...
                {streamingMessage && (
                  <div className="bg-white dark:bg-gray-800/80 text-gray-800 dark:text-gray-200 rounded-xl px-5 py-4 shadow-sm border border-gray-100 dark:border-gray-700/50 transition-colors duration-200">
                    ...
                    <div className="relative">
                      ...
                      <span className="inline-block w-0.5 h-4 bg-blue-500 dark:bg-blue-400 ml-1 animate-pulse align-middle"></span>
                    </div>
                  </div>
                )}
                {/* Initial loading state before any content */}
                {!thinkingContent && !isActivelyThinking && !streamingMessage && (
                  <div className="bg-white dark:bg-gray-800/80 rounded-xl px-5 py-3 shadow-sm border border-gray-100 dark:border-gray-700/50 transition-colors duration-200">
                    <div className="flex items-center space-x-3">
                      <div className="flex space-x-1">
                        <div className="w-1.5 h-1.5 bg-gray-400 dark:bg-gray-500 rounded-full animate-bounce" />
                        <div className="w-1.5 h-1.5 bg-gray-400 dark:bg-gray-500 rounded-full animate-bounce" style={{ animationDelay: '0.1s' }} />
                        <div className="w-1.5 h-1.5 bg-gray-400 dark:bg-gray-500 rounded-full animate-bounce" style={{ animationDelay: '0.2s' }} />
                      </div>
